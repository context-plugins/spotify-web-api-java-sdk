...
| `AlbumGroup` | [`AlbumGroup`](../../doc/models/album-group.md) | Required | - | AlbumGroup getAlbumGroup() | setAlbumGroup(AlbumGroup albumGroup) |
...
ArtistDiscographyAlbumObject artistDiscographyAlbumObject = new ArtistDiscographyAlbumObject.Builder(
