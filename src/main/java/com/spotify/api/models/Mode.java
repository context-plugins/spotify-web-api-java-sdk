...
public enum Mode {
    ...
    private static TreeMap<Integer, Mode> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static Mode constructFromInteger(Integer toConvert) throws IOException {
        Mode enumValue = fromInteger(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given integer value.
     */
    public static Mode fromInteger(Integer toConvert) {
    ...
    /**
     * Convert list of Mode values to list of integer values.
     * @param toConvert The list of Mode values to convert.
     * @return List of representative integer values.
     */
    public static List<Integer> toValue(List<Mode> toConvert) {
        if (toConvert == null) {
            return null;
        }
