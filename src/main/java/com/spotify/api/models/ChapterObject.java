...
public class ChapterObject {
    ...
    public String toString() {
        return "ChapterObject [" + "audioPreviewUrl=" + audioPreviewUrl + ", chapterNumber="
                ...
                + resumePoint + ", restrictions=" + restrictions + ", additionalProperties="
    ...
    public static class Builder {
        ...
        public ChapterObject build() {
            ChapterObject model =
                    new ChapterObject(audioPreviewUrl, chapterNumber, description, htmlDescription,
                            durationMs, explicit, externalUrls, href, id, images, isPlayable,
                            languages, name, releaseDate, releaseDatePrecision, type, uri,
                            audiobook, availableMarkets, resumePoint, restrictions);
