...
public class PrivateUserObject {
     ...
     * [user-read-private](https://developer.spotify.com/documentation/web-api/concepts/scopes/#list-of-scopes)
     * scope._
     ...
     * [user-read-email](https://developer.spotify.com/documentation/web-api/concepts/scopes/#list-of-scopes)
     * scope._
     * @return Returns the String
     */
    @JsonGetter("email")
    ...
    public static class Builder {
        ...
        public PrivateUserObject build() {
            PrivateUserObject model =
                    new PrivateUserObject(country, displayName, email, explicitContent,
                            externalUrls, followers, href, id, images, product, type, uri);
