...
public class SimplifiedTrackObject {
     ...
     * Relinking](https://developer.spotify.com/documentation/web-api/concepts/track-relinking/) is
    ...
    public String toString() {
        return "SimplifiedTrackObject [" + "artists=" + artists + ", availableMarkets="
                ...
                + isLocal + ", additionalProperties=" + additionalProperties + "]";
    }
    ...
    public static class Builder {
        ...
        public SimplifiedTrackObject build() {
            SimplifiedTrackObject model =
                    new SimplifiedTrackObject(artists, availableMarkets, discNumber, durationMs,
                            explicit, externalUrls, href, id, isPlayable, linkedFrom, restrictions,
                            name, previewUrl, trackNumber, type, uri, isLocal);
