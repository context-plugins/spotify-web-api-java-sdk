...
public class AudioFeaturesObject {
     ...
     * @param  type  Type8 value for type.
    ...
    public String toString() {
        return "AudioFeaturesObject [" + "acousticness=" + acousticness + ", analysisUrl="
                ...
                + ", valence=" + valence + ", additionalProperties=" + additionalProperties + "]";
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder type(Type8 type) {
            this.type = type;
            return this;
        }
        ...
        public AudioFeaturesObject build() {
            AudioFeaturesObject model =
                    new AudioFeaturesObject(acousticness, analysisUrl, danceability, durationMs,
                            energy, id, instrumentalness, key, liveness, loudness, mode,
                            speechiness, tempo, timeSignature, trackHref, type, uri, valence);
