...
/**
 * This is a model class for AudiobookBase type.
 */
public class AudiobookBase {
     ...
     * @param  type  Type9 value for type.
    ...
    /**
     * Setter for Type.
     * @param type Value for Type9
     */
    @JsonSetter("type")
    public void setType(Type9 type) {
        this.type = type;
    }
    ...
    /**
     * Converts this AudiobookBase into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AudiobookBase [" + "authors=" + authors + ", availableMarkets=" + availableMarkets
                ...
                + ", uri=" + uri + ", totalChapters=" + totalChapters + ", edition=" + edition
                + ", additionalProperties=" + additionalProperties + "]";
    }

    /**
     * Builds a new {@link AudiobookBase.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link AudiobookBase.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(authors, availableMarkets, copyrights, description,
                ...
                name, narrators, publisher, type, uri, totalChapters)
                .edition(getEdition());
    ...
    /**
     * Class to build instances of {@link AudiobookBase}.
     */
    public static class Builder {
        ...
        public Builder(List<AuthorObject> authors, List<String> availableMarkets,
                ...
                List<NarratorObject> narrators, String publisher, Type9 type, String uri,
                int totalChapters) {
            this.authors = authors;
            this.availableMarkets = availableMarkets;
            this.copyrights = copyrights;
         ...
         * @return Builder
         */
        public Builder type(Type9 type) {
            this.type = type;
            return this;
        }
        ...
        /**
         * Builds a new {@link AudiobookBase} object using the set fields.
         * @return {@link AudiobookBase}
         */
        public AudiobookBase build() {
            AudiobookBase model =
                    new AudiobookBase(authors, availableMarkets, copyrights, description,
                            htmlDescription, explicit, externalUrls, href, id, images, languages,
                            mediaType, name, narrators, publisher, type, uri, totalChapters,
                            edition);
