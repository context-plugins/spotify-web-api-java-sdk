...
public class TrackObject {
    ...
    protected TrackObject(SimplifiedAlbumObject album, List<ArtistObject> artists,
            ...
            Integer trackNumber, Type3 type, String uri, Boolean isLocal) {
        this.album = album;
        this.artists = artists;
        this.availableMarkets = availableMarkets;
        this.discNumber = discNumber;
    ...
    public static class Builder {
        ...
        public TrackObject build() {
            TrackObject model =
                    new TrackObject(album, artists, availableMarkets, discNumber, durationMs,
                            explicit, externalIds, externalUrls, href, id, isPlayable, linkedFrom,
                            restrictions, name, popularity, previewUrl, trackNumber, type, uri,
                            isLocal);
