 ...
 */
public final class PlayerApi extends BaseApi {

    /**
     * Initializes the controller.
     * @param globalConfig    Configurations added in client.
     */
    public PlayerApi(GlobalConfiguration globalConfig) {
        super(globalConfig);
    }
     ...
     * @param  additionalTypes  Optional parameter:
     ...
     */
    private ApiCall<ApiResponse<ManyDevices>, ApiException> prepareGetAUsersAvailableDevicesRequest() {
    ...
    public ApiResponse<Void> startAUsersPlayback(
            ...
            final StartOrResumePlaybackRequest body) throws ApiException, IOException {
     ...
     * users who have Spotify Premium. The order of execution is not guaranteed when you use this
     * API with other Player API endpoints.
     * @param  positionMs  Required parameter:
     * @param  deviceId  Optional parameter:
     * @return    Returns the Void wrapped in ApiResponse response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     ...
     * @param  volumePercent  Required parameter:
     * @param  deviceId  Optional parameter:
     * @return    Returns the Void wrapped in ApiResponse response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     ...
     * @param  after  Optional parameter:
     * @param  before  Optional parameter:
     ...
     */
    private ApiCall<ApiResponse<QueueObject>, ApiException> prepareGetQueueRequest() {
