 ...
 */
public final class GenresApi extends BaseApi {

    /**
     * Initializes the controller.
     * @param globalConfig    Configurations added in client.
     */
    public GenresApi(GlobalConfiguration globalConfig) {
        super(globalConfig);
    }
     ...
     */
    private ApiCall<ApiResponse<ManyGenres>, ApiException> prepareGetRecommendationGenresRequest() {
