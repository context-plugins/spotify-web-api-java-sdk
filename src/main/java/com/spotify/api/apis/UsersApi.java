...
import com.spotify.api.models.ItemType1;
import com.spotify.api.models.ItemType2;
import com.spotify.api.models.ItemType3;
...
public final class UsersApi extends BaseApi {
     ...
     */
    private ApiCall<ApiResponse<PrivateUserObject>, ApiException> prepareGetCurrentUsersProfileRequest() {
     ...
     * @param  playlistId  Required parameter:
    ...
    public ApiResponse<Void> followArtistsUsers(
            ...
            final String ids,
            final FollowArtistsOrUsersRequest body) throws ApiException, IOException {
    ...
    public ApiResponse<Void> unfollowArtistsUsers(
            ...
            final String ids,
            final UnfollowArtistsOrUsersRequest body) throws ApiException, IOException {
