 ...
 */
public final class PlaylistsApi extends BaseApi {

    /**
     * Initializes the controller.
     * @param globalConfig    Configurations added in client.
     */
    public PlaylistsApi(GlobalConfiguration globalConfig) {
        super(globalConfig);
    }
     ...
     * @param  playlistId  Required parameter:
     * @param  position  Optional parameter:
     * @param  uris  Optional parameter:
     * @param  body  Optional parameter:
     ...
     * tracks](https://developer.spotify.com/documentation/web-api/reference/add-tracks-to-playlist).)
