 ...
 */
public final class TracksApi extends BaseApi {

    /**
     * Initializes the controller.
     * @param globalConfig    Configurations added in client.
     */
    public TracksApi(GlobalConfiguration globalConfig) {
        super(globalConfig);
    }
    ...
    public ApiResponse<Void> saveTracksUser(
            final String ids,
            final SaveTracksRequest body) throws ApiException, IOException {
    ...
    public ApiResponse<Void> removeTracksUser(
            final String ids,
            final RemoveTracksRequest body) throws ApiException, IOException {
     ...
     * @param  limit  Optional parameter: Example: 20
     * @param  market  Optional parameter:
     * @param  seedArtists  Optional parameter:
     * @param  seedGenres  Optional parameter:
     * @param  seedTracks  Optional parameter:
     * @param  minAcousticness  Optional parameter:
     * @param  maxAcousticness  Optional parameter:
     * @param  targetAcousticness  Optional parameter:
     * @param  minDanceability  Optional parameter:
     * @param  maxDanceability  Optional parameter:
     * @param  targetDanceability  Optional parameter:
     * @param  minDurationMs  Optional parameter:
     * @param  maxDurationMs  Optional parameter:
     * @param  targetDurationMs  Optional parameter:
     * @param  minEnergy  Optional parameter:
     * @param  maxEnergy  Optional parameter:
     * @param  targetEnergy  Optional parameter:
     * @param  minInstrumentalness  Optional parameter:
     * @param  maxInstrumentalness  Optional parameter:
     * @param  targetInstrumentalness  Optional parameter:
     * @param  minKey  Optional parameter:
     * @param  maxKey  Optional parameter:
     * @param  targetKey  Optional parameter:
     * @param  minLiveness  Optional parameter:
     * @param  maxLiveness  Optional parameter:
     * @param  targetLiveness  Optional parameter:
     * @param  minLoudness  Optional parameter:
     * @param  maxLoudness  Optional parameter:
     * @param  targetLoudness  Optional parameter:
     * @param  minMode  Optional parameter:
     * @param  maxMode  Optional parameter:
     * @param  targetMode  Optional parameter:
     * @param  minPopularity  Optional parameter:
     * @param  maxPopularity  Optional parameter:
     * @param  targetPopularity  Optional parameter:
     * @param  minSpeechiness  Optional parameter:
     * @param  maxSpeechiness  Optional parameter:
     * @param  targetSpeechiness  Optional parameter:
     * @param  minTempo  Optional parameter:
     * @param  maxTempo  Optional parameter:
     * @param  targetTempo  Optional parameter:
     * @param  minTimeSignature  Optional parameter:
     * @param  maxTimeSignature  Optional parameter:
     * @param  targetTimeSignature  Optional parameter:
     * @param  minValence  Optional parameter:
     * @param  maxValence  Optional parameter:
     * @param  targetValence  Optional parameter:
